                    ...
                    <div class=""modal-content>
                        ...
                        <div class="modal-body">
                            <form name="input" method="post" action="matkul/matkul_update.php">
                                ...
                                <input type="text" id="fid" value="<?php echo $row['ID_Matkul']?>" maxlength="6" required>
                                <label for="fnama">Nama</label>
                                <input type="text" id="fnama" value="<?php echo $row['Nama_Matkul']?>" required>
                                <label for="fsks">SKS</label>
                                <input type="number" id="fsks" value="<?php echo $row['SKS_Matkul']?>" required min=1 max=4>
                                <label for="fnama">Semester</label>
                                <input type="number" id="fsemester" value="<?php echo $row['Semester']?>" required min=1>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form name="input" method="post" action="matkul/matkul_input.php">
                ...
                <label for="fsks">SKS</label>
                <input type="number" id="fsks" placeholder="SKS" required min=1 max=4>
                <label for="fnama">Semester</label>
