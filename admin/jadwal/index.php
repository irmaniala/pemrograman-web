...
<div class="tabel-page">
    ...
    <div class="search-box">
        <form method="get" action="#">
            ...
            ?>
                <option value="<?php echo $row['Dosen']?>">
    ...
    <table id="list-data" class="display">
        ...
        <?php
            ...
            $sql = "SELECT * from dosen as d
                        ...
                        INNER JOIN jadwal as j ON j.ID_Matkul AND j.ID_Dosen = d.ID_Dosen
        ...
        ?>
                ...
                <tr>
                   ...
                   <td><?php echo $row["Naama_Ruangan"];?></td> 
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form name="input" method="post" action="jadwal/jadwal_mengajar_update.php">
                                ...
                                <input type="text" id="fnama" list="hari" value="<?php echo $row['Hari']?>" required>
                                <datalist id="hari">
...
<!-- Get Data Dosn, Mata Kuliah Ruangan -->
<?php
    include "../config/db_connection.php";
    // Dosen
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form name="input" method="post" action="jadwal/jadwal_mengajar_input.php">
                ...
                <!-- Select Data Dosen -->
                <?php
                while($1_dosen = mysqli_fetch_assoc($dosen)) {
                ?>
                    <option value="<?php echo $1_dosen['ID_Dosen']?>">
                        <?php echo $1_dosen['Nama_Dosen']?>
                    </option>
                <?php
                }
                ?>
                ...
                <datalist id="matkul">
                    ...
                    <?php
                    while($1_matkul = mysqli_fetch_assoc($matkul)) {
                    ?>
                        <option value="<?php echo $1_matkul['ID_Matkul']?>">
                            <?php echo $1_matkul['Nama_Matkul']?>
                        </option>
                    <?php
                    }
                    ?>
                ...
                <!-- Select Data Ruangan -->
                <?php
                while($1_r = mysqli_fetch_assoc($ruangan)) {
                ?>
                    <option value="<?php echo $1_r['ID_Ruangan']?>">
                        <?php echo $1_r['Nama_Ruangan']?>
                    </option>
                <?php
                }
                ?>
                ...
                <!-- Data Hari -->
                <label for="fahri">Hari : <input list="hari" name="hari" type="text">
                </label>
                <datalist id="hari">
                    <option value="Senin"></option>
                    <option value="Selasa"></option>
