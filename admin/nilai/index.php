    ...
    <div class="data-result">
        <table id="list-data" class="display">
            ...
            <?php
                ...
                $tingkat = "0";
                if(iseet($_GET['tingkat'])){
                    $_tingkat = "'".$_GET['tingkat']."'";
...
?>
    <div class="table-page">
        ...
        <div class="button-container">
            <button class="button-input" id="myBtn" onclick="showmodal(0)">
        ...
        <table id="list-data" class="display">
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <button class="button-edit" id="buttonEdit" onclick="showmodal(<?php echo $i?>)">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form name="input" method="post" action="nilai/nilai_update.php">
                                <input type="hidden" name="old_id" value="<?php echo $row['NIM']?>">
    ...
    <div id="myModal10" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <span class="close" id="close0">&items;</span>
