                ...
                <div class=""modal-content>
                    ...
                    <div class="modal-body">
                        <form name="input" method="post" action="mahasiswa/mahasiswa_update.php">
                            ...
                            <input type="text" id="fnama" name="nama" value="<?php echo $row['Nama_Mhs']?>" rrequired>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form name="input" method="post" action="mahasiswa/mahasiswa_input.php">
                ...
                <label for="ftingkat">Tingkat</label>
                <input type="text" id="ftingkat" list="tingkat" name="tingkat" placeholder="Tingkat" min=1 required>
                    <datalist id="tingkat">
