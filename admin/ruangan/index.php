                ...
                <div id="myModal<?php echo $i?>" class="modal">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form name="input" method="post" action="ruangan/ruangan_upfate.php">
                                <label for="fid">ID Dosen</label>
                                <input type="text" id="fid" value="<?php echo $row['ID_Ruangan']?>" maxlength="7" readonly>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form name="input" method="post" action="ruangan/ruangan_input.php">
                ...
                <label for="fnama">Nama</label>
                <input type="text" id="fnama" placeholder="Nama" required>
                <input type="submit">
            </form>
        </div>
    </div>
