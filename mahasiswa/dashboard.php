...
<?php
    ...
    $sql = "SELECT * FROM nilai as n
            INNER JOIN mahasiswa as m ON m.NIM = "$_SESSION['nim']." NAD m.NIM = n.NIM
    ...
    <table id="list-data" class="display">
        ...
        ?>
                ...
                <tr>
                    ...
                    <td><?php echo $row["Jam-Masuk"]."-".$row["Jam_Keluar"];?></td>
                </tr>
        <?php
                }
            }
