...
<head>
    ...
    <!-- <link href="../style/datatables.min.css" rel="styleseet" /> --> 
...
<body>
    <div class="container">
        <div id="page-h" class="page-header">
            ...
            <a href="?page=dosen"><i class="fa fa-user-o fa-icon" aria-hidde="true"></i>Daftar Dosen</a>
